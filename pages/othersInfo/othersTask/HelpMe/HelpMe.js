    ...
    taskListTmp: [
      {
        ...
        giftList: {
          'donuts': {
            giftPic: app.globalData.urlb + '/images/pic/donuts.png',
            giftName: '甜甜圈',
            giftNum: 3,
          },
          'chips': {
            giftPic: app.globalData.urlb + '/images/pic/FrenchFries.png',
            giftName: '薯条',
            giftNum: 2,
          },
          'drumstick': {
            giftPic: app.globalData.urlb + '/images/pic/chickenLeg.png',
            giftName: '鸡腿',
            giftNum: 1,
          },
          'watermelon': {
            giftPic: app.globalData.urlb + '/images/pic/watermelon.png',
            giftName: '西瓜',
            giftNum: 1,
          },
          'candy': {
            giftPic: app.globalData.urlb + '/images/pic/candy.png',
            giftName: '糖果',
            giftNum: 10,
          },
        },
...

      {
        ...
        nickName: '小汤姆',
        initiatorId: '000002',
        initiatorPic: app.globalData.urlb + '/images/pic/jerry.jpg',
        gender: 'm',
        initiatorTitle: '见习雷锋',
...

      {
        ...
        nickName: '产品精灵',
        initiatorId: '000003',
        initiatorPic: app.globalData.urlb + '/images/pic/cute.jpg',
        gender: 'f',
        initiatorTitle: '少先队员',
        contactInfo: '手机：123123123',
